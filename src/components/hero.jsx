...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Sticky Navigation Cylinder */}
      <div className="fixed top-5 z-50 bg-white/10 backdrop-blur-lg px-8 py-3 rounded-full flex gap-6 text-sm sm:text-base font-semibold shadow-md">
